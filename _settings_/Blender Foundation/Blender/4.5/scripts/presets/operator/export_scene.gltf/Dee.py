...
op.filepath = 'C:\\Projects\\v4-51-golf\\Project\\Scenes\\GLBs\\Curved.export.glb'
...
op.export_gltfpack_kn = False
op.export_format = 'GLB'
op.ui_tab = 'GENERAL'
op.export_copyright = 'Dee'
op.export_image_format = 'AUTO'
op.export_image_add_webp = True
op.export_image_webp_fallback = True
...
op.export_unused_images = True
op.export_unused_textures = True
...
op.export_merge_animation = 'ACTION'
